...
def run(apply_diff):
    ...
    if w_gloads:
        ...
        if use_pload:
            ...
            print(f'disp_expected: {disp_expected}')
        rot_0 = o3.get_ele_response(osi, ele, 'section', extra_args=['1', 'deformation'])[1]
        shear_0 = o3.get_ele_response(osi, ele, 'section', extra_args=['1', 'deformation'])[2]
        print(o3.get_ele_response(osi, ele, 'section', extra_args=['2', 'deformation']))
